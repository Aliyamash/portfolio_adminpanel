...
export default function Header () {
    return (
        <>
            <div className="flex justify-between rounded-xl border text-lg mb-5 shadow shadow-lg bg-gray-200">
            ...
            <div className="flex items-center gap-2 bg-gray-300 px-10 py-5 rounded ">
